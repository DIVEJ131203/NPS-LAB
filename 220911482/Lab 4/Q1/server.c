...
int main()
{
	...
	strcpy(stu[0].student_id,"220911004");
	strcpy(stu[1].student_id,"220911012");
	strcpy(stu[0].subject_id[0],"ICT123");
	strcpy(stu[0].subject_id[1],"ICT234");
	strcpy(stu[0].subject_id[2],"HUM456");
	strcpy(stu[1].subject_id[0],"ICT123");
	strcpy(stu[1].subject_id[1],"ICT234");
	strcpy(stu[1].subject_id[2],"HUM456");
	strcpy(stu[0].fname,"Siddhartha");
	strcpy(stu[1].fname,"Darshan");
	strcpy(stu[0].lname,"M H");
	strcpy(stu[1].lname,"Nakshatri");
	...
	strcpy(stu[0].add,"Udupi");
	strcpy(stu[1].add,"Parkala");
	strcpy(stu[0].dep,"IT");
	strcpy(stu[1].dep,"IT");
	strcpy(sub[0].subject_id,"ICT123");
	strcpy(sub[1].subject_id,"ICT234");
	strcpy(sub[2].subject_id,"HUM456");
	strcpy(sub[0].subject_name,"DAA");
	...
	strcpy(cle[0].cycle_name,"2023");
	strcpy(cle[1].cycle_name,"2024");
	strcpy(stime[0].subject_id,"ICT123");
	strcpy(stime[1].subject_id,"ICT234");
	strcpy(stime[2].subject_id,"HUM456");
	strcpy(stime[0].day,"TUESDAY");
	strcpy(stime[1].day,"MONDAY");
	strcpy(stime[2].day,"THURSDAY");
	strcpy(stime[0].time,"09:00");
	strcpy(stime[1].time,"10:30");
	strcpy(stime[2].time,"03:30");
	char PID[5];
	while(1)
	{
